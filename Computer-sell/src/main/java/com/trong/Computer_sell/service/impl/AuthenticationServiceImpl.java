...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public TokenResponse getAccessToken(SignInRequest request) {
        ...
        try{
            ...
            log.error("Failed to authenticate user: {} - Bad credentials", request.getUsername());
            throw new BadCredentialsException("Sai tên đăng nhập hoặc mật khẩu!");
        } catch (DisabledException e) {
            log.error("Failed to authenticate user: {} - Account disabled", request.getUsername());
    ...
    public TokenResponse getRefreshToken(SignInRequest request) {
        log.info("Generating refresh token for user: {}", request.getUsername());
